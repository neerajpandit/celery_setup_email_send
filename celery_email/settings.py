...
SECRET_KEY = 'django-insecure-w7n00_=@1$lq(hs5ah^)i0#l-kv-$0w2e*g^*d@g^$$jm6ehp5'
...
CELERY_BROKER_URL = 'redis://http://127.0.0.1:6379/0'
CELERY_RESULT_BACKEND = 'redis://http://127.0.0.1:6379/0'
